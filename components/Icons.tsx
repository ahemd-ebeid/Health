...
export const Leaf: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13V8a7.99 7.99 0 0 1 14.24-4.24 8 8 0 0 1-2.48 11.76Z"/><path d="M11 20v-9"/></svg>
);
...
export const Dumbbell: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.4 14.4 9.6 9.6"/><path d="M18.657 21.485a2 2 0 1 1-2.829-2.828l-1.767 1.768a2 2 0 1 1-2.829-2.828l-1.768 1.768a2 2 0 1 1-2.828-2.828l1.768-1.768a2 2 0 1 1 2.828-2.828l1.768-1.768a2 2 0 1 1 2.829 2.828l1.767-1.768a2 2 0 1 1 2.829 2.828z"/><path d="m21.5 21.5-1.4-1.4"/><path d="m3.9 3.9 1.4 1.4"/><path d="M2.464 21.485a2 2 0 1 0 2.829-2.828l1.768 1.768a2 2 0 1 0 2.828-2.828l1.768 1.768a2 2 0 1 0 2.829-2.828l-1.768-1.768a2 2 0 1 0-2.828-2.828l-1.768-1.768a2 2 0 1 0-2.828 2.828l-1.768 1.768a2 2 0 1 0-2.829 2.829z"/></svg>
);
...
export const Male: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="10" r="4" /><path d="M12 14v8" /><path d="m9 18 3 3 3-3" /></svg>
);

export const Female: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="8" r="4" /><path d="M12 12v10" /><path d="M8 18h8" /></svg>
);
