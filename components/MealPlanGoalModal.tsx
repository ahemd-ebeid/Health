...
import { TrendingUp, TrendingDown, X } from './Icons';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 text-center transform transition-all animate-fadeIn relative">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-3 w-36 h-32 bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-200 font-bold rounded-xl hover:bg-red-200 dark:hover:bg-red-800/80 transition-all duration-300 transform hover:scale-105"
          >
