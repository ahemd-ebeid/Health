...
const Chatbot: React.FC<ChatbotProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed bottom-0 ${language === 'ar' ? 'md:left-6 left-0' : 'md:right-6 right-0'} md:bottom-24 w-full md:w-[400px] h-[70vh] md:h-[600px] z-50 transition-all duration-300 ease-in-out ${isOpen ? 'transform translate-y-0 opacity-100' : 'transform translate-y-full opacity-0 pointer-events-none'}`}>
      <div className="bg-white dark:bg-gray-800 rounded-t-2xl md:rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 flex flex-col h-full">
        ...
        <div ref={chatContainerRef} className="flex-1 p-4 md:p-6 space-y-5 overflow-y-auto bg-gray-50/50 dark:bg-gray-900/50">
